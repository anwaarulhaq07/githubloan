...
<div class="card">
    <p class="card-header text-center"> {{ trans('Complete Transaction History') }} </p>
    <div class="card-header">
        ...
        <div style="float: right;">
            <form action="{{route('admin.limit_history')}}" method="post">
                @csrf
            ...
            <form action="{{route('complete_history_excel')}}" method="post">
                @csrf
